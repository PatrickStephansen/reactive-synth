...
export enum AudioGraphActionTypes {
  ...
  CreateRectifierNode = '[Audio Graph] Create Rectifier Node',
...
export class CreateRectifierNode implements Action {
  readonly type = AudioGraphActionTypes.CreateRectifierNode;
